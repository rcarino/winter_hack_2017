...
class Login extends Component {
    ...
    return (
      <div className="details" style={{ marginBottom: '200px' }}>
        ...
        <div className="info" style={{ margin: '15px 40px' }}>
          ...
          <div style={{marginBottom: '5px'}}>
            <label style={{ color: '#233259', fontFamily: 'Roboto', fontWeight: 'bolder', fontSize: '13px' }}>League: </label>
            <span>ZogSports</span>
          </div>
          <div>
            <label style={{ color: '#233259', fontFamily: 'Roboto', fontWeight: 'bolder', fontSize: '13px' }}>Category: </label>
            <span>Basketball</span>
          </div>
        </div>
        <img src="https://s3.amazonaws.com/sportspass.hack/reviews.png" style={{ width: '100%', margin: '20px auto' }} />
        {this.props.location.pathname.indexOf('confirmed') === -1  && (
          <div className="waiver" style={{ width: '80%', margin: '20px auto' }}>
  ...
  9. I HAVE READ THIS WAIVER AND RELEASE OF LIABILITY CAREFULLY AND I FULLY UNDERSTAND ITS TERMS, AND I UNDERSTAND THAT I HAVE GIVEN UP SUBSTANTIAL RIGHTS BY SIGNING THIS DOCUMENT, AND I SIGN IT KNOWINGLY, INTELLIGENTLY AND VOLUNTARILY WITHOUT ANY INDUCEMENT OR DURESS.<br/>
        ...
        {this.props.location.pathname.indexOf('confirmed') === -1 ? (
          ...
          <Link to="confirmation" className="reserve" style={bookedStyle}>BOOKED</Link>
        )}
      </div>
    )
  }
